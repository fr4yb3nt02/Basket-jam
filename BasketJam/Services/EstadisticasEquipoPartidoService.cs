...
namespace BasketJam.Services
{
    ...
    a => a.IdEquipo.Equals(eep.IdEquipo) && a.IdPartido.Equals(eep.IdPartido), // encuentro el partido
    Builders<EstadisticasEquipoPartido>.Update.Set(c => c.Puntos, EstadisticasEquipoPartido.Puntos + eep.Puntos));
                return true;
            }
        }
        ...
        public async Task<Boolean> CargarEstadistica(string IdPartido, string IdEquipo, int ptos)
        {
            ...
            else
            {
                int puntos = EstadisticasEquipoPartido.Puntos;
                await _estadisticasEquipoPartido.UpdateOneAsync(
    a => a.IdEquipo.Equals(IdEquipo) && a.IdPartido.Equals(IdPartido), //busco el partido
    Builders<EstadisticasEquipoPartido>.Update.Set(c => c.Puntos, EstadisticasEquipoPartido.Puntos + ptos));
        ...
        public async Task<Boolean> CargarTiempoMueto(string IdPartido, string IdEquipo, int tiempoMuerto)
        {
            ...
            else
            {
                ...
                await _estadisticasEquipoPartido.UpdateOneAsync(
    a => a.IdEquipo.Equals(IdEquipo) && a.IdPartido.Equals(IdPartido), // busco coincidencia
    Builders<EstadisticasEquipoPartido>.Update.Set(c => c.TiemposMuertos, EstadisticasEquipoPartido.TiemposMuertos + tiempoMuerto));
                return true;
            }
        }
